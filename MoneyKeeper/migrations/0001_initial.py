    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(related_name='transactions', to='MoneyKeeper.Account')),
                ('category', models.ForeignKey(related_name='transactions', blank=True, to='MoneyKeeper.Category', null=True)),
                ('transfer_to_account', models.ForeignKey(related_name='transfers', blank=True, to='MoneyKeeper.Account', null=True)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
